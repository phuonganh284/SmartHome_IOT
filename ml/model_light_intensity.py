...
# 3. only use rows with light_on=1 ------------------------------
df = df[df['light_on'] == 1]
...
# 9. export model -----------------------------------------------
joblib.dump(model, "light_intensity_model.pkl")
print(df['light_intensity'].describe())
print("Model saved as light_intensity_model.pkl")