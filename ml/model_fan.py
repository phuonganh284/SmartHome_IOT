...
DEFAULT_CSV_PATH = Path("data_fan.csv")  # Cập nhật đường dẫn đến file CSV của bạn
...
def load_model(model_path="fan_model.pkl"):
...
def main():
    fit_sklearn_model(DEFAULT_CSV_PATH)

    result = predict_speed_from_values(20.0, 40.0)
    print(result)
